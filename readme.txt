En el momento que se corra el servidor, se debera ingresar a http://localhost:8000/base/ para que se muestre el inicio de la pagina. Luego se puede proceder a ingresar a cada
