...
from peliculas.views import create_movie_view, pelis, series_1, create_serie_view, juegos, create_game_view, search_view, Detail_peliculas, Detail_series, Detail_games, Delete_pelicula
